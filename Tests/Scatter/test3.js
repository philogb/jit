femaleJSON = [[161.2, 51.6], [167.5, 59.0], [159.5, 49.2], [157.0, 63.0], [155.8, 53.6], 
...
maleJSON = [[174.0, 65.6], [175.3, 71.8], [193.5, 80.7], [186.5, 72.6], [187.2, 78.8], 
...
function convertToJSON(n, x, y, category, color) {
  return {
    "id": "node"+n,
    "name": "node"+n,
    "data": {
...
for (var i in maleJSON) {
  var pos = maleJSON[i];
  json.push(convertToJSON(i, pos[0], pos[1], "male", "blue"));
}

var initialFemale = maleJSON.length;
for (var i in femaleJSON) {
  var pos = femaleJSON[i];
  json.push(convertToJSON(initialFemale+i, pos[0], pos[1], "female", "red"));
}
