...
$jit.RadarChart = new Class({
  ...
  refresh: function() {
   ...
   /*
     ...
     json - The JSON data format. This format can be seen in Tests/RadarChart/1.js

     Example:
     (start code js)
     var lineChart = new $jit.RadarChart(options);
